...
#ifndef UMEM_END_VMA
// Cover user text/data (0xC0000000+), user heap (0xE0000000-0xF0000000), and
// stack page at top.  Pages are lazily allocated on page fault, so the large
// virtual range is fine even with little physical RAM.
#define UMEM_END_VMA 0x0F0000000UL
#endif
